...
#define X_COMPARE_EXCHANGE(Type, ArithType, ordering) (void* ptr, Type* expected, Type x) { return __atomic_compare_exchange_n((Type*)ptr, expected, x, false, ordering, ordering); }
