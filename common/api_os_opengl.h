...
typedef void (APIENTRYP PFNGLMULTIDRAWELEMENTSBASEVERTEX)(GLenum mode, const GLsizei *count, GLenum type, const GLvoid * const *indices, GLsizei drawcount, const GLint *basevertex);
typedef void (APIENTRYP PFNGLMULTIDRAWELEMENTS)(GLenum mode, const GLsizei *count, GLenum type, const GLvoid * const *indices, GLsizei drawcount);

#define _GL_FUNCTIONS_X_MACRO_ES20(X) \
...
#define _GL_FUNCTIONS_X_MACRO_ES30(X) \
...
#define _GL_FUNCTIONS_X_MACRO_ES31(X) \
...
#define _GL_FUNCTIONS_X_MACRO_ES32(X) \
	X(PFNGLBLENDBARRIERPROC,glBlendBarrier) \
	...
	X(PFNGLPRIMITIVEBOUNDINGBOXPROC,glPrimitiveBoundingBox) \
...
#define _GL_FUNCTIONS_X_MACRO_DESKTOP_EXCLUSIVE(X) \
	X(PFNGLMULTIDRAWARRAYS,glMultiDrawArrays) \
	X(PFNGLMULTIDRAWELEMENTS,glMultiDrawElements) \
	X(PFNGLMULTIDRAWELEMENTSBASEVERTEX,glMultiDrawElementsBaseVertex) \
...
struct OS_OpenGLApi
{
	...
	void (*present)(OS_OpenGLApi* api);
	void (*resize_buffers)(OS_OpenGLApi* api);
...
#define X(Type, Name) Type Name;
	...
	_GL_FUNCTIONS_X_MACRO_DESKTOP_EXCLUSIVE(X)
#undef X
};

struct OS_OpenGLApiDesc
{
	OS_Window window;
	int32 swap_interval;
}
typedef OS_OpenGLApiDesc;

API bool OS_MakeOpenGLApi(OS_OpenGLApi* out_api, OS_OpenGLApiDesc const* args);
API bool OS_FreeOpenGLApi(OS_OpenGLApi* api);

#ifdef __cplusplus
static inline bool OS_MakeOpenGLApi(OS_OpenGLApi* out_api, OS_OpenGLApiDesc const& args) { return OS_MakeOpenGLApi(out_api, &args); }
#endif
